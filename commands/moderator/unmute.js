module.exports.run = async (client, message, args) => {
    ...
    if (!member.roles.cache.has(role.id)) return client.errors(message, 'err', 'That user is not muted.');
    ...
    try {
        await member.roles.remove(role.id, `Unmuted by ${message.author.tag}`);
    } catch (e) {
